...
import '../modules/home/sections/plantation_page.dart';
import '../modules/home/sections/profile_page.dart';
import '../modules/home/home/home_page.dart';
...
List<GetPage> getAppPages() {
  return [
    ...
    GetPage(name: RegisterScreen.route, page: () => const RegisterScreen(), binding: BindingsBuilder(() => Get.lazyPut(() => RegisterController()))),
